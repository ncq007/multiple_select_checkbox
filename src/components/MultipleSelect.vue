<template>
  <el-select v-model="selectValues" v-bind="$attrs" multiple placeholder="请选择" class="multiple_select_checkbox" @change="changeSelect">
...
.multiple_select_checkbox >>> .el-select-dropdown {
  text-align: left;
}

/* .multiple_select_checkbox >>> .el-select-dropdown__item:not(:first-child) {
  display: inline-block;
}

.multiple_select_checkbox >>> .el-select-dropdown__item.selected::after {
  content: "";
} */
</style>